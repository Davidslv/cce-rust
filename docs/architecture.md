...
| `src/sync/mod.rs` | CCE Sync identity helpers — content address, `repo_id`, pack-set id, sync home, artifact-format version (SPEC-SYNC §2–4) | `content_address`, `normalize_repo_id`, `pack_set_id`, `SYNC_FORMAT_VERSION`, `sync_home` |
